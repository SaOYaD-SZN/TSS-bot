...
CATEGORIES = {
    "moderation": {
        ...
        "commands": [
            ...
            "clearwarnings", "purge", "lock", "unlock", "slowmode", "setnick",
            "addrole", "removerole",
        ],
    },
    "economy": {
        ...
        "commands": [
            "rank", "leaderboard", "balance", "daily", "work", "pay", "shop",
            "buy", "inventory", "additem", "removeitem", "addcoins",
        ],
    },
    "fun": {
        ...
        "color": COLORS["fun"],
        "commands": [
            "8ball", "coinflip", "roll", "rps", "ship", "compliment", "meme",
            "joke", "hug", "pat", "cuddle", "poke", "trivia", "guess",
        ],
    },
    "utility": {
        ...
        "commands": [
            "ping", "userinfo", "serverinfo", "avatar", "botinfo", "poll",
            "remindme", "afk", "timestamp", "suggest",
        ],
    },
    "tickets": {
        ...
        "commands": [
            "setwelcome", "setleave", "testwelcome", "ticketsetup", "ticketpanel",
            "addtoticket", "closeticket",
        ],
    },
    "study": {
        ...
        "color": COLORS["study"],
        "commands": [
            "pomodoro", "studytimer", "studytip", "checkin", "streak", "todo",
            "todolist", "tododone", "tododelete",
        ],
    },
}
...
def category_embed(bot, key):
    ...
    embed = discord.Embed(title=cat["label"], description="\n".join(lines), color=cat["color"])
...
class HelpSelect(discord.ui.Select):
    def __init__(self, bot):
        self.bot = bot
        options = [discord.SelectOption(label=cat["label"], value=key) for key, cat in CATEGORIES.items()]
    ...
    async def help_command(self, ctx):
        ...
        embed = discord.Embed(
            ...
            description=(
                ...
                f"**{len(CATEGORIES)}** categories. Pick one below to see what I can do! {EMOJI['sparkle']}"
            ),
